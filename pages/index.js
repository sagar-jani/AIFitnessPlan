  ...
  return (
    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <div className=' flex items-center justify-center flex-col background-gradient'>
        ...
        <h1 className='text-white text-2xl md:text-5xl font-bold mt-20 mb-10'>HOW IT WORKS</h1>
        ...
        <h1 className='text-white text-2xl md:text-5xl font-bold mt-20'>Nutrition &amp; Workout Plan</h1>
        <div className='grid grid-cols-2 d-flex justify-content-center align-items-center gap-10'>
          <div className='mx-auto'>
        ...
        <Link href="/plan" className="inline-flex items-center xs:px-5 xs:py-2 md:px-10 mt-20 md:py-5 xs:text-lg md:text-2xl font-medium text-center justify-center text-white bg-primary rounded-3xl hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >
