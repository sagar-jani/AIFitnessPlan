        ...
        <div className=' flex items-center justify-center flex-col '>
          ...
          {/* <div className='grid grid-cols-2 grid-rows-1 gap-10 mt-10 mb-10'>
            <div className='col-span-1 row-span-1 flex items-center justify-center'>
              <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div className='mx-auto relative h-24 grid grid-cols-2'>
                  <div className='relative'>
                    <Image  className="rounded-t-lg pt-5 pl-5" src="/images/diet-plan-input.png" alt="" />
                  </div>

                </div>
                <div className="p-5">

                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white bg-primary text-center rounded-xl">STEP 1</h5>
            ...
            <div className='col-span-1 row-span-1 flex items-center justify-center'>
              <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <Image className="rounded-t-lg pt-14" src="/images/image.png" alt="" height={150} width={860} />
                <div className="p-5">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white bg-primary text-center rounded-xl">STEP 2</h5>
          ...
          <div className='fixed bottom-0 right-0 mr-4 mb-5 font-bold text-xl '>
            <a
              ...
              className='right-0 bottom-0 mb-4 mr-4 font-mono text-white  rounded-xl p-4 ' rel="noreferrer"
            >
              Made By @SagarJani
            </a>
          </div>
