  ...
  return (
    <>
      ...
      <div className="flex flex-row mb-10 items-center justify-center ">
        ...
        <div className="mr-5 px-5 py-10 bg-black text-white  placeholder-sky-200 border border-gray-200 rounded-xl shadow-md text-5xl dark:bg-gray-800 dark:border-gray-700">
