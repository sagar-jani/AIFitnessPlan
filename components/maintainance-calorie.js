  ...
  return (
    <>
      <div className="text-center mb-5 mt-10">
        <p className="text-black text-2xl font-bold">Your Maintenance Calories</p>
      </div>

      <div className="flex flex-row mb-10 items-center justify-center ">

        <div className="mr-10 px-12 py-12 bg-black text-white  placeholder-sky-200 border border-gray-200 rounded-xl shadow-md text-5xl dark:bg-gray-800 dark:border-gray-700">
          {tdee}
        </div>
